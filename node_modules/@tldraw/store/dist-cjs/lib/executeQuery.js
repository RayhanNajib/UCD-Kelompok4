...
function executeQuery(store, typeName, query) {
  ...
  const matchIds = (0, import_utils.objectMapFromEntries)(
    matcherPaths.map(({ path }) => [path, /* @__PURE__ */ new Set()])
  );
  ...
  return (0, import_setUtils.intersectSets)((0, import_utils.objectMapValues)(matchIds));
}
