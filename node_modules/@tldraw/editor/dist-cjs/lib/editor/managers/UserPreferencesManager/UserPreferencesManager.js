...
class UserPreferencesManager {
  constructor(user, colorScheme) {
    ...
    const reducedMotionMediaQuery = (0, import_dom.getGlobalWindow)().matchMedia("(prefers-reduced-motion: reduce)");
  ...
  systemPrefersReducedMotion = (0, import_state.atom)("systemPrefersReducedMotion", false);
  ...
  getAnimationSpeed() {
    return this.user.userPreferences.get().animationSpeed ?? (this.systemPrefersReducedMotion.get() ? 0 : 1);
  }
