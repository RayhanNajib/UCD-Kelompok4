...
function getCroppedImageDataForReplacedImage(imageShape, newImageWidth, newImageHeight) {
  ...
  const isOriginalCrop = !!imageShape.props.crop && isEqual(imageShape.props.crop.topLeft, defaultCrop.topLeft) && isEqual(imageShape.props.crop.bottomRight, defaultCrop.bottomRight) && !imageShape.props.crop.isCircle;
  if (isOriginalCrop) {
