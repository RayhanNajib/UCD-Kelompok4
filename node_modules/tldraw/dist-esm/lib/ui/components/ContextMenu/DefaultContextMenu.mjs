...
import { ContextMenuPagePointContext } from "../../context/actions.mjs";
...
const ContextMenuRoot = _ContextMenu.Root;
const DefaultContextMenu = memo(function DefaultContextMenu2({
  ...
  return /* @__PURE__ */ jsxs(ContextMenuRoot, { dir, open: isOpen, onOpenChange: handleOpenChange, modal: false, children: [
    /* @__PURE__ */ jsx(
      _ContextMenu.Trigger,
      {
        onContextMenu: menuCanOpen ? void 0 : preventDefault,
        dir: "ltr",
