...
function ActionsProvider({ overrides, children }) {
  ...
  return /* @__PURE__ */ jsx(ContextMenuPagePointContext.Provider, { value: rContextMenuPagePoint, children: /* @__PURE__ */ jsx(ActionsContext.Provider, { value: asActions(actions), children }) });
}
function useActions() {
