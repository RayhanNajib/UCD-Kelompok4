...
const arrowInfoCache = (0, import_store.createComputedCache)(
  ...
  (editor, shape) => {
    ...
    const sw = "getDefaultDisplayValues" in util.options && "getCustomDisplayValues" in util.options ? (0, import_getDisplayValues.getDisplayValues)(util, shape).strokeWidth : editor.getCurrentTheme().strokeWidth * import_default_shape_constants.STROKE_SIZES[shape.props.size];
