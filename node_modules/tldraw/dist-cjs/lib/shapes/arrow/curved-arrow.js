  ...
  if (startShapeInfo && !startShapeInfo.isExact) {
    ...
    if (point) {
      ...
      if (arrowheadStart !== "none") {
        const strokeOffset = arrowSW / 2 + ("size" in startShapeInfo.shape.props ? theme.strokeWidth * (import_default_shape_constants.STROKE_SIZES[startShapeInfo.shape.props.size] ?? 0) / 2 : 0);
  ...
  if (endShapeInfo && !endShapeInfo.isExact) {
    ...
    if (point) {
      ...
      if (arrowheadEnd !== "none") {
        const strokeOffset = arrowSW / 2 + ("size" in endShapeInfo.shape.props ? theme.strokeWidth * (import_default_shape_constants.STROKE_SIZES[endShapeInfo.shape.props.size] ?? 0) / 2 : 0);
