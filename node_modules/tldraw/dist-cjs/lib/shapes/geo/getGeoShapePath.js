...
function getXBoxPath(w, h, sw, dash, isFilled) {
  ...
  path.moveTo((0, import_editor.clamp)(sw * inset, 0, w), (0, import_editor.clamp)(sw * inset, 0, h), {
    geometry: { isInternal: true, isFilled: false }
  }).lineTo((0, import_editor.clamp)(w - sw * inset, 0, w), (0, import_editor.clamp)(h - sw * inset, 0, h)).moveTo((0, import_editor.clamp)(w - sw * inset, 0, w), (0, import_editor.clamp)(sw * inset, 0, h), {
    geometry: { isInternal: true, isFilled: false }
  }).lineTo((0, import_editor.clamp)(sw * inset, 0, w), (0, import_editor.clamp)(h - sw * inset, 0, h));
  return path;
}
