...
function getCroppedImageDataForReplacedImage(imageShape, newImageWidth, newImageHeight) {
  ...
  const isOriginalCrop = !!imageShape.props.crop && (0, import_editor.isEqual)(imageShape.props.crop.topLeft, defaultCrop.topLeft) && (0, import_editor.isEqual)(imageShape.props.crop.bottomRight, defaultCrop.bottomRight) && !imageShape.props.crop.isCircle;
  if (isOriginalCrop) {
