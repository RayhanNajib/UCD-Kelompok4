...
__export(actions_exports, {
  ...
  ContextMenuPagePointContext: () => ContextMenuPagePointContext,
...
const ContextMenuPagePointContext = React.createContext(null);
...
function ActionsProvider({ overrides, children }) {
  ...
  const rContextMenuPagePoint = React.useRef(null);
  const actions = React.useMemo(() => {
    ...
    const actionItems = [
      ...
      },
      {
        ...
        kbd: "cmd+v,ctrl+v",
        onSelect(source) {
          const point = source === "context-menu" ? rContextMenuPagePoint.current ?? editor.inputs.getCurrentPagePoint() : void 0;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ContextMenuPagePointContext.Provider, { value: rContextMenuPagePoint, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ActionsContext.Provider, { value: asActions(actions), children }) });
}
function useActions() {
