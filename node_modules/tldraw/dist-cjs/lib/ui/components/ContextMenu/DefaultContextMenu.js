...
const ContextMenuRoot = import_radix_ui.ContextMenu.Root;
const DefaultContextMenu = (0, import_react.memo)(function DefaultContextMenu2({
  ...
  const rContextMenuPagePoint = (0, import_react.useContext)(import_actions.ContextMenuPagePointContext);
  const cb = (0, import_react.useCallback)(
    (isOpen2) => {
      const body = editor.getContainerDocument().body;
      if (rContextMenuPagePoint) {
        rContextMenuPagePoint.current = isOpen2 ? editor.inputs.getCurrentPagePoint().clone() : null;
      }
      if (!isOpen2) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ContextMenuRoot, { dir, open: isOpen, onOpenChange: handleOpenChange, modal: false, children: [
