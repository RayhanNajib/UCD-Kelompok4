...
function DefaultMinimap() {
  ...
  const rMinimap = React.useRef(null);
  (0, import_editor.usePassThroughWheelEvents)(rMinimap);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: rMinimap, className: "tlui-minimap", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "canvas",
    {
      ref: rCanvas,
      role: "img",
