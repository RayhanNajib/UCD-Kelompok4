...
class Resizing extends import_editor.StateNode {
  ...
  updateShapes() {
    ...
    const scaleOriginHandle = (0, import_editor.rotateSelectionHandle)(dragHandle, Math.PI);
    ...
    if (shouldSnap && selectionRotation % import_editor.HALF_PI === 0) {
      const { nudge } = editor.snaps.shapeBounds.snapResizeShapes({
        ...
        initialSelectionPageBounds,
        handle: (0, import_editor.rotateSelectionHandle)(dragHandle, selectionRotation),
        isAspectRatioLocked,
