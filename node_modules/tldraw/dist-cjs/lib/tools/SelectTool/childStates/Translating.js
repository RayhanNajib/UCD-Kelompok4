...
function getTranslatingSnapshot(editor) {
  ...
  if (noteSnapshot) {
    ...
    const dv = (0, import_getDisplayValues.getDisplayValues)(noteUtil, noteSnapshot.shape);
    noteAdjacentPositions = (0, import_noteHelpers.getAvailableNoteAdjacentPositions)(editor, {
    ...
    noteCenterOffset = new import_editor.Vec(dv.noteWidth / 2, dv.noteHeight / 2);
  }
  return {
